...
def sortLeaderboardHighToLow():
    leaderboard = list()
    with open(
            '/Users/eshaanbhattadf/Desktop/nflbracketchallengeapp/data/brackets.json') as data:
...
def updateScores():
    ...
    with open(
            '/Users/eshaanbhattadf/Desktop/nflbracketchallengeapp/data/brackets.json') as data:
        brackets = json.load(data)
    with open('/Users/eshaanbhattadf/Desktop/nflbracketchallengeapp/data/perfectbracket.json') as data:
...
def getRemainingPointsPossible(id):
    games = ['afcWildCard1', 'afcWildCard2', 'afcWildCard3', 'nfcWildCard1',
             ...
             'superbowl']
    points = [2, 2, 2, 2, 2, 2, 3, 3, 3, 3, 6, 6, 12]
    teams = ['Las Vegas Raiders', 'Cincinnati Bengals', 'New England Patriots', 'Buffalo Bills', 'Philadelphia Eagles', 'Tampa Bay Buccaneers', 'San Francisco 49ers',
...
def alternativeScoring():
    winners = {'WildCard': ['Bills', 'Buccaneers', 'Saints', 'Ravens', 'Browns', 'Rams'],
               'Divisional': ['Packers', 'Buccaneers', 'Chiefs', 'Bills'],
               'Champions': ['Buccaneers', 'Chiefs'],
               'superbowl': ['TBD']
               }
